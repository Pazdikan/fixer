...
export default function WelcomeScreen() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-600 to-pink-600">
      <div
        className={`bg-white rounded-lg shadow-2xl p-8 m-4 max-w-sm w-full transition-all duration-500 ease-in-out ${
          isVisible
      ...
      >
        ...
        <p className="text-center text-gray-600 mb-8">
          A text-based, semi-incremental web game where you take on the role of
          a fixer in the near future
        </p>
